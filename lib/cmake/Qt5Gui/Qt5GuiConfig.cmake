...
set(Qt5Gui_VERSION_STRING 5.15.17)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/QtGui/5.15.17"
        "${_qt5Gui_install_prefix}/include/QtGui/5.15.17/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.17 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 opengles2;dynamicgl;angle;combined-angle-lib;opengles3;opengles31;opengles32;openvg;system-textmarkdownreader)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_ENABLED_PRIVATE_FEATURES
                 xkbcommon;xkbcommon-x11;xcb;accessibility-atspi-bridge;egl;egl_x11;eglfs;xlib;xcb-xlib;eglfs_x11;evdev;freetype;system-freetype;fontconfig;gif;harfbuzz;ico;imageio-text-loading;jpeg;linuxfb;multiprocess;png;raster-64bit;system-harfbuzz;system-jpeg;system-png;tuiotouch;vkgen;vnc;xcb-egl-plugin;xcb-glx-plugin;xcb-glx;xcb-sm)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 angle_d3d11_qdtd;direct2d;direct2d1_1;dxgi;direct3d11;direct3d11_1;direct3d9;directfb;drm_atomic;dxgi1_2;dxguid;eglfs_brcm;kms;eglfs_egldevice;eglfs_gbm;eglfs_mali;eglfs_openwfd;eglfs_rcar;eglfs_viv;eglfs_viv_wl;eglfs_vsp2;integrityfb;integrityhid;libinput;libinput-axis-api;mtdev;system-xcb-xinput;tslib;vsp2;xcb-native-painting)
    ...
    _populate_Gui_target_properties(RELEASE "libQt5Gui.so.5.15.17" "" FALSE)
