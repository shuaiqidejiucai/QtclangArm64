...
set(Qt5WaylandClient_VERSION_STRING 5.15.17)
...
if (NOT TARGET Qt5::WaylandClient)
    ...
    set(Qt5WaylandClient_PRIVATE_INCLUDE_DIRS
        "${_qt5WaylandClient_install_prefix}/include/QtWaylandClient/5.15.17"
        "${_qt5WaylandClient_install_prefix}/include/QtWaylandClient/5.15.17/QtWaylandClient"
    )
    ...
    foreach(_module_dep ${_Qt5WaylandClient_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.17 ${_Qt5WaylandClient_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::WaylandClient
                 ...
                 wayland-brcm;wayland-dmabuf-server-buffer;wayland-libhybris-egl-server-buffer)
    ...
    _populate_WaylandClient_target_properties(RELEASE "libQt5WaylandClient.so.5.15.17" "" FALSE)
